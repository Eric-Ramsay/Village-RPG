...
void initLocations() {
	...
	// Buildings
	Location Tavern("Tavern", "The *BLUE*Tavern*GREY* is four stories, and boasts no fewer than twenty-five rooms for rent, though these days only a few are ever rented out at a time.\n\nMore than a few townspeople come to the *RED*firelit*GREY* common room for dinner or drinks at its bar, which is enough for *YELLOW*Penelope*GREY* to maintain the establishment.\n\nIt's said that *GREEN*Asha*GREY*, sitting perpetually at the bar and living in a rented room accounts for half of the tavern's total revenue.");
	Tavern.parent = "Merchant Lane";
	Tavern.people = { "Penelope", "Asha", "Clyde" };

	Location Tailor("Tailor", "The *BLUE*Tailor Shop*GREY* is well stocked with all the latest gowns and garments, intricately crafted by *YELLOW*Florence*GREY* herself. Painted a dark brown in its interior to accent the colorful fabrics within, it's one of the newest additions to *RED*Merchant Lane*GREY*.\n\nBehind several fashionable displays, hidden in a back corner, is a mannequin adorned in old *CYAN*highland chainmail*GREY*. When asked about it, *YELLOW*Florence*GREY* only looks away with a sly, fading laugh.");
	...
	Location Curio("Curio Shop", "The *BLUE*Curio Shop*GREY* is a maze of narrow hallways and tiny rooms, formed by hanging carpets and shelves that rise from the floor to the low ceiling.\n\nEvery imaginable sort of thing can be found cluttered onto a shelf somewhere in the shop, from ancient artifacts to tarnished copper toys. *YELLOW*Minsiki*GREY* scours every merchant ship that pulls into the harbor, looking for more *PINK*strange wares*GREY* to sell.");
	Curio.parent = "Harbor";
	Curio.people = { "Minsiki" };

	Location Runes("Rune Shop", "The *BLUE*Rune Shop*GREY* is a dusty wooden building, jointly owned by the siblings *YELLOW*Sarkana*GREY* and *YELLOW*Terat*GREY* in spite of their animosity for one another.\n\nThey've hung a sheet from the ceiling to divide the space behind the counter in half, and watch eagerly to see whose runes you intend to buy.");
	Runes.parent = "Harbor";
	...
	Location Library("Library", "The *BLUE*Library*GREY* is an old building, discreetly tucked into a corner of the *YELLOW*plaza*GREY*. The books are all held in a single spacious room, partitioned by a *CYAN*labyrinth*GREY* of tall bookshelves, some of which are subdivided by a wooden platform that acts as a partial second floor.\n\nThe air is stale and dusty, and if you wander past the *GREEN*books*GREY* you'll come upon a bedroom and office where *PINK*Elias*GREY* lives and works.");
	Library.parent = "Churchyard";
	Library.people = { "Elias" };

	Location Bank("Bank", "The *BLUE*Bank*GREY* is a low, unassuming building of *BLACK*old grey stone*GREY*. It has a single circular window on its front face, but is otherwise lit by *YELLOW*dim lamps*GREY*.\n\nDespite its modest appearance the building has been reinforced by *PINK*ancient runes*GREY* that completely protect any and all *CYAN*deposits*GREY*.");
	Bank.parent = "Town Square";

	Location Apothecary("Apothecary", "The *BLUE*Apothecary*GREY* is little more than a tiny room and a counter, even smaller than the *BLUE*Curio Shop*GREY*. There is a door behind the counter which no one but *YELLOW*Qarana*GREY* has seen the other side of.\n\nOn each wall are shelves of glass potion bottles that rattle as the shop door opens and closes. Within the shop a slight metallic, almost *RED*bloody*GREY* smell lingers, mixing with a *GREEN*sour*GREY*, smoky scent. If ever it's mentioned, *YELLOW*Qarana*GREY* insists it's coming from the *YELLOW*Kobos's*GREY* stall next door.");
	Apothecary.parent = "Town Square";
	Apothecary.people = { "Qarana" };

	Location Smithy("Smithy", "The *BLUE*Smithy*GREY* is more of a pavillion rather than a shop, always shimmering in the *RED*fiery*GREY* radiance of the ingot furnace.\n\nMost of *YELLOW*Kobos*GREY*'s work consists of mundane orders for the town, nails, fish hooks, anchors, and the like, though many adventurers seek him out for his legendary weapons and armor.\n\nMany of his finest masterpieces hang behind his counter. *YELLOW*Kobos*GREY* doesn't worry about theft, though - he knows no one would dare to *RED*steal*GREY* from him again.");
